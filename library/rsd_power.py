...
description:
    ...
    - "The node on which power action will be performed can by identify by
...
node:
    ...
    contains:
        ...
        required_power_action:
            description: Print power action specified by user.
        previus_power_state:
            description: Previous power state of the node.
        possible_power_actions:
            description: Print supported power actions of the node.
