...
description:
    - rsd_boot module override node boot properties.
    - The node on which boot override action will be performed can
      be identify by one of the following: uuid, identity, or name.

options:
    boot_target:
        description:
            - Boot source to be used at next boot instead of the
              normal boot device.
...
node:
    ...
    contains:
        ...
        previous_boot_target:
            description: Previous boot source.
        previous_boot_enable:
            description: Previous state of the boot source.
        previous_boot_mode:
            description: Previous BIOS boot mode.
        requested_boot_target:
            description: Requested boot source.
        requested_boot_enable:
            description: Requested state of the boot source.
        requested_boot_mode:
            description: Requested BIOS boot mode.

    sample:
        "id": "1",
        "name": "node_01",
        "previous_boot_enable": "Continuous",
        "previous_boot_mode": "Legacy",
        "previous_boot_target": "Hdd",
        "requested_boot_enable": "Once",
        "requested_boot_mode": "Legacy",
        "requested_boot_target": "Pxe",
